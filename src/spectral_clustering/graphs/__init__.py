...
__all__ = ['knn_graph', 'fully_connected', 'epsilon_graph', 'adaptive_neighbour_graph', 'gauss_similarity', 'gauss_knn_similarity', 'solve_adaptive_neighbour_row', 'compute_laplacian']